...
def ingest_rag_document(file_path: str) -> str:
    ...
    if os.path.exists(DB_PATH):
        # Append to existing index instead of overwriting it
    ...
    # Refresh in-memory cache so the next rag_tool call sees the update
...
def rag_tool(query: str) -> str:
    ...
    for index, document in enumerate(documents, start=1):
        ...
        # PyPDFLoader page numbers are 0-indexed; show human-friendly page numbers
